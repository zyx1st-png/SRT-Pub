...
|---|---|---:|---:|---:|
| `SRT_CONTEXT_BUNDLE_SPINE.md` | 骨架 spine | 15 | 341,121 | ~148,490 |
| `SRT_CONTEXT_BUNDLE_COMPACTCORE.md` | CompactCore 全集 | 19 | 152,641 | ~71,700 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_AI.md` | 领域 AI | 6 | 69,951 | ~26,941 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHYSICS.md` | 领域 Physics | 11 | 80,535 | ~34,300 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHILOSOPHY.md` | 领域 Philosophy | 6 | 92,207 | ~34,418 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_NEUROSCIENCE.md` | 领域 Neuroscience | 6 | 120,864 | ~41,618 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_SPIRITUALITY.md` | 领域 Spirituality | 3 | 36,674 | ~14,168 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_CORE.md` | 领域 Core | 1 | 22,107 | ~9,671 |
...
|---|---|---:|---:|---|
| 骨架路线（裁定定义时用） | `SPINE` | 148,490 | 51,510 | 需要确定 SRT 术语、公理、方程、符号含义时，只装这一个。 |
...
| 组合 | 合计 ≈token | 为什么禁止 |
|---|---:|---|
| SPINE + COMPACTCORE | **220,190** | 旧版曾把它推荐为跨域方案；两包合计已**超出**整个窗口，装不下。 |

### `SPINE` + 各领域包（逐个列出，均不推荐）

| 组合 | 合计 ≈token | 是否在预算内 |
|---|---:|:---:|
| `SPINE` + `DOMAIN_AI` | 175,431 | **超预算** |
| `SPINE` + `DOMAIN_PHYSICS` | 182,790 | **超预算** |
| `SPINE` + `DOMAIN_PHILOSOPHY` | 182,908 | **超预算** |
| `SPINE` + `DOMAIN_NEUROSCIENCE` | 190,108 | **超预算** |
| `SPINE` + `DOMAIN_SPIRITUALITY` | 162,658 | **超预算** |
| `SPINE` + `DOMAIN_CORE` | 158,161 | **超预算** |
