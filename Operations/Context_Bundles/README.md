...
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHILOSOPHY.md` | 领域 Philosophy | 6 | 92,749 | ~34,572 |
...
| 单域（体量最大者：Philosophy） | `DOMAIN_PHILOSOPHY` | 34,572 | 165,428 | 单领域问答；领域包自带 claim-status 护栏与导航。 |
...
| `SPINE` + `DOMAIN_PHILOSOPHY` | 183,769 | **超预算** |
