...
|---|---|---:|---:|---:|
| `SRT_CONTEXT_BUNDLE_SPINE.md` | 骨架 spine | 16 | 336,252 | ~144,888 |
| `SRT_CONTEXT_BUNDLE_COMPACTCORE.md` | CompactCore 全集 | 19 | 146,052 | ~68,379 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_AI.md` | 领域 AI | 6 | 62,815 | ~24,341 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHYSICS.md` | 领域 Physics | 11 | 73,697 | ~31,828 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHILOSOPHY.md` | 领域 Philosophy | 6 | 86,743 | ~32,642 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_NEUROSCIENCE.md` | 领域 Neuroscience | 5 | 59,104 | ~23,548 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_SPIRITUALITY.md` | 领域 Spirituality | 3 | 35,255 | ~13,557 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_CORE.md` | 领域 Core | 1 | 20,803 | ~8,993 |
...
| 轻量跨域 | `COMPACTCORE` | 68,379 | 131,621 | 只需领域主线、不需裁定定义时用。 |
| 单域（体量最大者：Philosophy） | `DOMAIN_PHILOSOPHY` | 32,642 | 167,358 | 单领域问答；领域包自带 claim-status 护栏与导航。 |
| 单域（体量最小者：Core 动力学） | `DOMAIN_CORE` | 8,993 | 191,007 | 最省的一种装法。 |

### 禁止的组合

| 组合 | 合计 ≈token | 为什么禁止 |
|---|---:|---|
| SPINE + COMPACTCORE | **213,267** | 旧版曾把它推荐为跨域方案；两包合计已**超出**整个窗口，装不下。 |
...
| `SPINE` + `DOMAIN_PHYSICS` | 176,716 | **超预算** |
| `SPINE` + `DOMAIN_PHILOSOPHY` | 177,530 | **超预算** |
| `SPINE` + `DOMAIN_NEUROSCIENCE` | 168,436 | **超预算** |
| `SPINE` + `DOMAIN_SPIRITUALITY` | 158,445 | **超预算** |
| `SPINE` + `DOMAIN_CORE` | 153,881 | 在预算内（但仍不推荐，见下） |
