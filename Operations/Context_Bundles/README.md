...
|---|---|---:|---:|---:|
| `SRT_CONTEXT_BUNDLE_SPINE.md` | 骨架 spine | 15 | 328,947 | ~144,573 |
| `SRT_CONTEXT_BUNDLE_COMPACTCORE.md` | CompactCore 全集 | 19 | 152,109 | ~71,551 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_AI.md` | 领域 AI | 6 | 69,419 | ~26,792 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHYSICS.md` | 领域 Physics | 11 | 80,003 | ~34,151 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHILOSOPHY.md` | 领域 Philosophy | 6 | 90,911 | ~34,048 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_NEUROSCIENCE.md` | 领域 Neuroscience | 6 | 120,332 | ~41,469 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_SPIRITUALITY.md` | 领域 Spirituality | 3 | 36,142 | ~14,020 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_CORE.md` | 领域 Core | 1 | 21,575 | ~9,522 |
...
| 单域（体量最大者：Philosophy） | `DOMAIN_PHILOSOPHY` | 34,048 | 165,952 | 单领域问答；领域包自带 claim-status 护栏与导航。 |
...
| `SPINE` + `DOMAIN_PHILOSOPHY` | 178,621 | **超预算** |
| `SPINE` + `DOMAIN_NEUROSCIENCE` | 186,042 | **超预算** |
| `SPINE` + `DOMAIN_SPIRITUALITY` | 158,593 | **超预算** |
