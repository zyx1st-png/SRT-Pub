...
|---|---|---:|---:|---:|
| `SRT_CONTEXT_BUNDLE_SPINE.md` | 骨架 spine | 15 | 318,119 | ~141,225 |
| `SRT_CONTEXT_BUNDLE_COMPACTCORE.md` | CompactCore 全集 | 19 | 148,693 | ~70,257 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_AI.md` | 领域 AI | 6 | 67,371 | ~26,157 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHYSICS.md` | 领域 Physics | 11 | 78,618 | ~33,660 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_PHILOSOPHY.md` | 领域 Philosophy | 6 | 89,298 | ~33,504 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_NEUROSCIENCE.md` | 领域 Neuroscience | 5 | 61,511 | ~24,440 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_SPIRITUALITY.md` | 领域 Spirituality | 3 | 35,226 | ~13,749 |
| `SRT_CONTEXT_BUNDLE_DOMAIN_CORE.md` | 领域 Core | 1 | 20,659 | ~9,251 |
...
|---|---|---:|---:|---|
| 骨架路线（裁定定义时用） | `SPINE` | 141,225 | 58,775 | 需要确定 SRT 术语、公理、方程、符号含义时，只装这一个。 |
...
| 组合 | 合计 ≈token | 为什么禁止 |
|---|---:|---|
| SPINE + COMPACTCORE | **211,482** | 旧版曾把它推荐为跨域方案；两包合计已**超出**整个窗口，装不下。 |

### `SPINE` + 各领域包（逐个列出，均不推荐）

| 组合 | 合计 ≈token | 是否在预算内 |
|---|---:|:---:|
| `SPINE` + `DOMAIN_AI` | 167,382 | **超预算** |
| `SPINE` + `DOMAIN_PHYSICS` | 174,885 | **超预算** |
| `SPINE` + `DOMAIN_PHILOSOPHY` | 174,729 | **超预算** |
| `SPINE` + `DOMAIN_NEUROSCIENCE` | 165,665 | **超预算** |
| `SPINE` + `DOMAIN_SPIRITUALITY` | 154,974 | 在预算内（但仍不推荐，见下） |
| `SPINE` + `DOMAIN_CORE` | 150,476 | 在预算内（但仍不推荐，见下） |
