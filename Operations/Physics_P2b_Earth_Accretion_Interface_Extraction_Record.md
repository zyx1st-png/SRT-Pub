...
This PR executes the small Earth accretion / reservoir-selection interface extraction allowed by `Operations/Physics_P2b_Earth_Accretion_Interface_Adjudication.md`.
