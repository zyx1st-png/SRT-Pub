...
`Operations/Physics_P0_Inventory_Frontmatter_Audit.md` identified the need for exact line counts and frontmatter verification across `Physics/*.md`.
...
- Add `Operations/Physics_P0b_Exact_Inventory_Report.md`.
- Optionally update `Operations/Physics_P0_Inventory_Frontmatter_Audit.md` to point to the exact report.
...
Read:
- Operations/Physics_P0_Inventory_Frontmatter_Audit.md
- Operations/Physics_P0b_Exact_Inventory_Handoff.md
- Physics/README.md
- Physics/SRT_Physics_Claim_Status.md

Task:
1. Run the exact inventory Python script from Operations/Physics_P0b_Exact_Inventory_Handoff.md.
2. Create Operations/Physics_P0b_Exact_Inventory_Report.md with the exact table, missing-pointer summary, high-risk-hit summary, and safety record.
...
- Add a one-line pointer in Operations/Physics_P0_Inventory_Frontmatter_Audit.md to the exact report.
...
This handoff intentionally avoids false precision. The next exact inventory must be run in a local/Codex environment with repository file access, then recorded in `Operations/Physics_P0b_Exact_Inventory_Report.md`.
