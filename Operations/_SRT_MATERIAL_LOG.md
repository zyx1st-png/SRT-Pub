...
| 2026-07-16 | 2026-10-16 | PhilPapers first-priority packet: Šekrst, Wu, Sulic, Georgatos, Simonelli, Rosenhagen, Sawyer（[packet index](../Materials/2026/INDEX_2026_07_16_SRT_First_Priority_Readings.md)） | Mixed packet：7/7 SourceCards complete；Šekrst 与 Wu 全文已取得并分别以 `AIEVID01`、`PH-AG02` patch 升级为 A；5/7 仍为 B 等待全文。下一优先为 Georgatos formal system、Simonelli bilateral semantics、Sulic subject formation。不得把剩余摘要卡写成全文精读、外部验证或 canonical 支撑 |
