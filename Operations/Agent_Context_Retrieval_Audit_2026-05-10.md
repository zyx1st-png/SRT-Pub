...
- large-file audit exists: `Operations/Large_File_Audit_2026-05-09.md`.
...
- `Operations/Large_File_Audit_2026-05-09.md` flags many active text files as warning/action/urgent size.
