...
- 引用更新：`SRT_NEXT_OPTIMIZATION_TODO.md`、`Operations/SRT_OPTIMIZATION_COMPLETION_AUDIT_2026-04-27.md`、`Experiments/` 下 4 文件、`05_Public_Release/PUBLIC_INDEX.md`、`scripts/governance_common.py`（移除 `Papers/` artifact 前缀）。
