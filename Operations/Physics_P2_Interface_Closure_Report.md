...
date: 2026-04-29
dependency:
  - Operations/Physics_P2_High_Risk_Category_Adjudication.md
  - Operations/Physics_P2a_QBox_Interface_Adjudication.md
  - Operations/Physics_P2a_QBox_Interface_Extraction_Record.md
  - Operations/Physics_P2b_Earth_Accretion_Interface_Adjudication.md
  - Operations/Physics_P2b_Earth_Accretion_Interface_Extraction_Record.md
...
| Stage | Record | Result |
|---|---|---|
| P2 category opening | `Operations/Physics_P2_High_Risk_Category_Adjudication.md` | High-risk categories classified and extraction blocked by default |
| P2-A adjudication | `Operations/Physics_P2a_QBox_Interface_Adjudication.md` | QBox safe extraction boundary fixed |
| P2-A extraction | `Operations/Physics_P2a_QBox_Interface_Extraction_Record.md` | QBox interface copied to `Physics/QBox_Annex/` |
| P2-B adjudication | `Operations/Physics_P2b_Earth_Accretion_Interface_Adjudication.md` | Earth accretion safe extraction boundary fixed |
| P2-B extraction | `Operations/Physics_P2b_Earth_Accretion_Interface_Extraction_Record.md` | Earth reservoir-selection interface copied to `Physics/Earth_Accretion_Annex/` |
