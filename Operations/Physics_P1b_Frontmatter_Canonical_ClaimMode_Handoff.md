...
`Operations/Physics_P0b_Exact_Inventory_Report.md` found:
...
Task:
1. Run the PR-P1B local script in Operations/Physics_P1b_Frontmatter_Canonical_ClaimMode_Handoff.md §3.
2. Run the verification script in §4.
3. Create Operations/Physics_P1b_Frontmatter_Canonical_ClaimMode_Record.md with changed files, assignment table, verification result, and safety record.
