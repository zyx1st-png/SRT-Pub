---
id: CODEX-PROMPT-PHIL-LONG-FILE-PH-SS-DIRECT-POINTERS-ROOT-COPY-2026-04-27
type: codex_prompt
tags: [Codex, Philosophy, PH-SS, Long-Files, Direct-Pointers, Safe-Patching]
...
canonical: false
date: 2026-04-27
source_copy_of: Operations/Codex_Prompts/2026-04-27_Philosophy_Long_File_PH_SS_Direct_Pointers.md
machine_summary: >
  Root-level fallback copy of the Codex prompt for safely patching long SRT Philosophy files.
  Use this if Claude Code / Codex cannot see Operations/Codex_Prompts.
---

# Codex Prompt — Philosophy Long-File PH-SS Direct Pointers

> Root-level fallback copy. Use this file if `Operations/Codex_Prompts/2026-04-27_Philosophy_Long_File_PH_SS_Direct_Pointers.md` is not visible from your tool.

---

## Prompt to Codex / Claude Code
...
If you are not on `zyx1st-png/SRT-Pub` and branch `main`, stop and report the mismatch.

### Context files to read first

Read these files before editing. If one is missing, report it and continue with the visible ones:
