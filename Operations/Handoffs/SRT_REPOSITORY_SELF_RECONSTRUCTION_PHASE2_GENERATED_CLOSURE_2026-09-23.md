...
Phase 2 semantic owner repair is drafted.

Phase 2 is **NOT COMPLETE** until deterministic generated closure and independent content review both pass.
...
- BCTB T1 provenance is already on main: relation-transfer is retained only as a secondary diagnostic candidate and T2 is not automatic;
...
These are Phase 3 / Phase 4 inputs only. Do not repair them until Phase 2 closure passes.

## 6. Next authorized step

```text
generated closure
-> independent Phase 2 content review
-> only then provenance / vocabulary reconciliation.
```
