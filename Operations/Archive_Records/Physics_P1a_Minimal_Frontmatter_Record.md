...
This PR addresses the highest-priority issue from `Operations/Archive_Records/Physics_P0b_Exact_Inventory_Report.md`: four Physics files had no YAML frontmatter.
