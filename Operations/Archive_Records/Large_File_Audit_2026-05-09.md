...
| urgent | 410.2 KiB | `Experiments/cycle1_shuffled_writeback_v2/reference_results.json` | - |
...
| urgent | 202.3 KiB | `Governance/Frontmatter_Warning_Baseline.txt` | missing_or_not_needed |
...
| urgent | 110.6 KiB | `Philosophy/SRT_Philosophy_Ethics.md` | Philosophy/Ethics_Split |
| urgent | 100.6 KiB | `Core/SRT_Core_14_Dynamics_Scaling.md` | Core/Dynamics_Scaling_Split |
...
| action | 91.3 KiB | `Physics/SRT_Physics_Cosmology.md` | Physics/Cosmology_Split |
| action | 90.1 KiB | `SRT_Glossary.md` | Glossary/README.md |
| action | 84.6 KiB | `Core/SRT_OPEN_TENSIONS.md` | missing_or_not_needed |
| action | 83.1 KiB | `AI/SRT_AI_01_Ontology.md` | AI/Ontology_Split |
| action | 82.7 KiB | `Philosophy/SRT_Philosophy_Foundations.md` | Philosophy/Foundations_Split |
| action | 82.5 KiB | `Core/SRT_Core_13a_Operator_Basics.md` | Core/Operator_Basics_Split |
| action | 82.1 KiB | `Governance/_SRT_CHANGELOG_2026.md` | Governance/_SRT_CHANGELOG_2026_Split |
...
| action | 70.4 KiB | `Philosophy/SRT_Social_Economics.md` | Philosophy/Social_Economics_Split |
| warning | 67.1 KiB | `Core_Law/SRT_Collective_Tower_Hardening_Notes.md` | Core_Law/Collective_Tower_Hardening_Notes_Split |
| warning | 66.9 KiB | `Philosophy/Papers/Forcing_CH_Research_Regime_Staged_Draft_EN.md` | missing_or_not_needed |
| warning | 66.3 KiB | `Core/SRT_Core_22_Equations.md` | Core/Equations_Split |
| warning | 64.5 KiB | `Physics/SRT_Phys_09_Formalism_Ext.md` | Physics/Formalism_Ext_Split |
| warning | 64.4 KiB | `01_Source_Intuition/SRT_CONSTITUTION_IDENTITY_AUTHOR_TRACE_2026-08-29.md` | missing_or_not_needed |
...
| warning | 60.5 KiB | `Philosophy/Papers/Forcing_CH_Evidence/CONTROL_ARCHIVE_SOURCE_MANIFEST.md` | missing_or_not_needed |
| warning | 59.5 KiB | `Neuroscience/SRT_Neuro_08_Immune_Dist.md` | Neuroscience/Immune_Dist_Split |
| warning | 59.5 KiB | `Core_Law/SRT_L1_Formalism.md` | Core_Law/L1_Formalism_Split |
...
| warning | 56.9 KiB | `Core/SRT_Core_12a_Ontology_L0L1.md` | Core/Ontology_L0L1_Split |
| warning | 56.6 KiB | `Philosophy/SRT_SocTheory_06_L2_Dynamics.md` | Philosophy/L2_Dynamics_Split |
| warning | 56.1 KiB | `Physics/SRT_Quant_01_Selection.md` | Physics/Selection_Split |
| warning | 54.9 KiB | `Neuroscience/SRT_Neuroscience_Reconstruction_Framework.md` | missing_or_not_needed |
| warning | 54.6 KiB | `Experiments/selective_resynchronization_mvp/outputs/processed/phase_summary.csv` | - |
| warning | 54.1 KiB | `Core_Law/SRT_Reference_Dynamics.md` | Core_Law/Reference_Dynamics_Split |
| warning | 53.7 KiB | `Philosophy/SRT_Epistemology_Reconstruction_Framework.md` | missing_or_not_needed |
| warning | 52.3 KiB | `_SRT_D_VALUE_CANONICAL.md` | missing_or_not_needed |
| warning | 51.4 KiB | `AI/Ontology_Annex/00_General_Boundary_Block.md` | AI/Ontology_Annex/General_Boundary_Block_Split |
| warning | 51.2 KiB | `AI/SRT_AI_Architecture.md` | AI/Architecture_Split |
| warning | 50.7 KiB | `Physics/SRT_Quant_02_Cosmology.md` | Physics/Quant_02_Cosmology_Split |
| warning | 50.3 KiB | `Philosophy/Papers/Forcing_CH_Evidence/CONTROL_ARCHIVE_COVERAGE_LOG.md` | missing_or_not_needed |
...
| urgent | 472.6 KiB | `Operations/Context_Bundles/SRT_CONTEXT_BUNDLE_SPINE.md` | artifact/generated; do not use as primary connector read path |
...
| urgent | 215.2 KiB | `Operations/Context_Bundles/SRT_CONTEXT_BUNDLE_COMPACTCORE.md` | artifact/generated; do not use as primary connector read path |
...
| urgent | 134.6 KiB | `Operations/Context_Bundles/SRT_CONTEXT_BUNDLE_DOMAIN_NEUROSCIENCE.md` | artifact/generated; do not use as primary connector read path |
...
| urgent | 109.2 KiB | `Operations/Context_Bundles/SRT_CONTEXT_BUNDLE_DOMAIN_PHILOSOPHY.md` | artifact/generated; do not use as primary connector read path |
...
| urgent | 105.3 KiB | `Operations/Context_Bundles/SRT_CONTEXT_BUNDLE_DOMAIN_PHYSICS.md` | artifact/generated; do not use as primary connector read path |
...
| action | 84.9 KiB | `Operations/Context_Bundles/SRT_CONTEXT_BUNDLE_DOMAIN_AI.md` | artifact/generated; do not use as primary connector read path |
...
| action | 69.4 KiB | `papers/history_dependent_reachability/manuscript/MANUSCRIPT.md` | artifact/generated; do not use as primary connector read path |
...
| urgent | 440.9 KiB | `Philosophy/Papers/Forcing_CH_Evidence/CONTROL_ARCHIVE_SWEEP_JSL_1950_1955_INVENTORY.tsv` | binary/media artifact |
...
| urgent | 205.8 KiB | `Philosophy/Papers/Forcing_CH_Evidence/CONTROL_ARCHIVE_SWEEP_JSL_1938_1943_INVENTORY.tsv` | binary/media artifact |
| urgent | 199.9 KiB | `Philosophy/Papers/Forcing_CH_Evidence/CONTROL_ARCHIVE_SWEEP_JSL_1944_1949_INVENTORY.tsv` | binary/media artifact |
...
| warning | 61.0 KiB | `scripts/build_srt_context_bundles.py` | binary/media artifact |
...
| 202.3 KiB | `Governance/Frontmatter_Warning_Baseline.txt` | missing_or_not_needed |
...
| 110.6 KiB | `Philosophy/SRT_Philosophy_Ethics.md` | Philosophy/Ethics_Split |
| 100.6 KiB | `Core/SRT_Core_14_Dynamics_Scaling.md` | Core/Dynamics_Scaling_Split |
...
| 91.3 KiB | `Physics/SRT_Physics_Cosmology.md` | Physics/Cosmology_Split |
| 90.1 KiB | `SRT_Glossary.md` | Glossary/README.md |
| 84.6 KiB | `Core/SRT_OPEN_TENSIONS.md` | missing_or_not_needed |
| 83.1 KiB | `AI/SRT_AI_01_Ontology.md` | AI/Ontology_Split |
| 82.7 KiB | `Philosophy/SRT_Philosophy_Foundations.md` | Philosophy/Foundations_Split |
| 82.5 KiB | `Core/SRT_Core_13a_Operator_Basics.md` | Core/Operator_Basics_Split |
| 82.1 KiB | `Governance/_SRT_CHANGELOG_2026.md` | Governance/_SRT_CHANGELOG_2026_Split |
...
| 70.4 KiB | `Philosophy/SRT_Social_Economics.md` | Philosophy/Social_Economics_Split |
