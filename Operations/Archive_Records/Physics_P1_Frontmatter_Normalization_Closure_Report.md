...
|---|---|---|
| Pre-audit | `Operations/Archive_Records/Physics_Split_Annex_PreAudit_2026-04-29.md` | Established Physics guardrails and Codex handoff |
| P0 | `Operations/Archive_Records/Physics_P0_Inventory_Frontmatter_Audit.md` | Created initial inventory map and high-risk labels |
| P0b | `Operations/Archive_Records/Physics_P0b_Exact_Inventory_Report.md` | Produced exact 25-file inventory, pointer gaps, and high-risk category summary |
| P1A | `Operations/Archive_Records/Physics_P1a_Minimal_Frontmatter_Record.md` | Added minimal frontmatter to 4 no-frontmatter files |
| P1B | `Operations/Archive_Records/Physics_P1b_Frontmatter_Canonical_ClaimMode_Record.md` | Normalized frontmatter-only `claim_mode` and `canonical` fields |
