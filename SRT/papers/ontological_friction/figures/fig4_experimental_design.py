...
for x, y, w, h, label, color, dur, ec in blocks:
    ...
    ax1.text(x + w/2, y - 0.3, dur, ha='center', va='center', fontsize=12, color='#666666')
...
design_text = ('Study Design\n'
               ...
               '3 sessions × 6 weeks\n'
               'ICC for test-retest')
ax1.text(6.0, 1.5, design_text, ha='center', va='center', fontsize=10,
...
ax2.plot(load, nonlinear_cost, '-', color='#C62828', linewidth=4.0, label='Bandwidth saturation model (SRT)')
...
ax2.set_xticklabels(level_labels, fontsize=18, color='#666')
...
plt.savefig('/Users/zhangyuxin/.openclaw/workspace/SRT/papers/ontological_friction/figures/fig4_experimental_design.png',
