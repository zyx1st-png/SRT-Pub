...
This is what philosophy looks like when it has to be built. Instead of arguing verbally about whether a system is alive, one can vary one dimension at a time and ask which changes alter the persistence of life-like organization.
