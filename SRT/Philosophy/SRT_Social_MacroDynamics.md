...
社会体制的动力学演化可在二维相图中定位。以 **$L_2$ 刚性**（Rigidity，即抵抗更新的迟滞系数 $\eta$）与 **$L_0$ 吸收率**（Absorption，即系统整合新变量的信道带宽）为轴，存在三种经典的拓扑相态：
...
- **典型形态**：官僚主义无限增殖、唯数据论闭环（详见 §8.4）；这与 §6.2 韦伯铁笼的 SRT 翻译在逻辑上闭合。
- **历史案例**：苏联晚期——僵化的计划指令无法吸收底层真实经济扰动。
