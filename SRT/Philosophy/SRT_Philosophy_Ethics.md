...
>
> * **FC-Altruism1-1**（证伪条件）：若在纵向研究中，d值代理↑（亲社会行为频率或共情量表分数）的群体，其应激激素（皮质醇/IL-6）水平或主观压力评分并未低于低d值对照（控制社会经济地位后，p>0.1），则"d↑⟹总摩擦↓"的物理预测不成立，SRT利他-摩擦联结失效，需重新检视"外部摩擦"是否可被Ψ_f完整捕捉。
