...
2. **提升 $P_{adapt}^{(i)}$**：扩大个体的可塑性（如 UBI 兜底生存风险以释放 $d$ 值带宽 [参见：Kangas et al. 2020 *Finland Basic Income Experiment* — 芬兰UBI实验，幸福感↑但就业效应有限；Stockton SEED项目 Murphey 2021 *ioby report* — 900美元/月，全职就业↑；Kenya GiveDirectly RCT Egger et al. 2022 *Quarterly Journal of Economics* — 长期现金转移促进创业和生产性投资，支持d值释放方向]；或通过教育提高 $\gamma_i$）。
