...
### B. 元数据层问题
- `Governance/_SRT_DOC_ENGINEERING_GUIDE.md` 要求 frontmatter，但当前大量文档未统一。
...
### P0-1 索引解耦（强烈建议）
- 新建：`SRT/Governance/_SRT_CHANGELOG_2026.md`
...
- 建立 `SRT/Governance/_SRT_FRONTMATTER_AUDIT.md`，列出覆盖率与缺失项。
...
- 新建：`SRT/Governance/_SRT_EXPLANATION_PROTOCOL.md`
- 规定每个核心条目必须含 5 段：
  1) 定义
  2) 形式化
  3) 机制解释
...
### P2-2 领域接入模板化
- 新建：`SRT/Governance/_SRT_DOMAIN_TEMPLATE.md`
- 新增领域文档必须按模板生成，确保 AI 可解析结构一致。

### P2-3 diff 流水线规范化
- 新建：`SRT/Governance/_SRT_DIFF_PIPELINE_GUIDE.md`
...
### P3-1 质量评分卡（每周）
新建：`SRT/Governance/_SRT_QUALITY_SCORECARD.md`，指标建议：
- 元数据覆盖率
- 断链率
- 术语冲突率
- 可证伪条目覆盖率
