...
**首次出现**：Core/SRT_Core_00_Intro.md §1.2.1
...
**首次出现**：Core/SRT_Core_00_Intro.md §1.2.2
...
**首次出现**：Core/SRT_Core_00_Intro.md §1.2.3
...
**首次出现**：Core/SRT_Core_00_Intro.md §1.3
...
**首次出现**：Core/SRT_Core_00_Intro.md §1.3.2
...
**对象澄清**：d 关切的是“存在边界”而非仅行为结果；当 \(d>0\) 时，关切从自身存在边界（自保）起步，再向他者存在扩展。
...
**规范来源**：AI/SRT_AI_01_Ontology.md Ax-ONT-3
**首次出现（术语化阐释）**：Core/SRT_Core_00_Intro.md §2.3
...
**首次出现**：Core/SRT_Core_00_Intro.md §2.2
...
**首次出现**：Core/SRT_Core_00_Intro.md §2.2.3
...
**首次出现**：Core/SRT_Core_00_Intro.md §2.4
...
**首次出现**：Core/SRT_Core_00_Intro.md 公理A9
...
**首次出现**：Core/SRT_Core_00_Intro.md §3.2
...
**首次出现**：Core/SRT_Core_00_Intro.md §1.3.2a
...
**首次出现**：Neuroscience/SRT_Neural_Mechanisms.md（历史路径，待迁移）
...
**首次出现**：Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移） §7.2
...
**首次出现**：Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移） §5
...
**首次出现**：AI/SRT_AI_00_Crisis.md §1.2.6
...
**首次出现**：Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移）
...
**首次出现**：Neuroscience/SRT_Neural_Mechanisms.md（历史路径，待迁移） §15
...
**首次出现**：Philosophy/SRT_Soc_01_Construction.md
...
**首次出现**：Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移） §2
...
**首次出现**：Neuroscience/SRT_Neural_Mechanisms.md（历史路径，待迁移） §1
...
**首次出现**：Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移） §8.1
...
**首次出现**：Neuroscience/SRT_Neuro_10_Advanced_Models.md（历史路径，待迁移） §10.7
...
**首次出现**：Neuroscience/SRT_Clin_01_Pathology.md（历史路径，待迁移） §1.4.1
...
**首次出现**：Neuroscience/SRT_Neuro_06_Field_Effects.md（历史路径，待迁移） §7.2.1
...
**首次出现**：Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移） §3
...
**首次出现**：Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移） §1
...
**首次出现**：AI/SRT_AI_00_Crisis.md §1.2.2b
...
**首次出现**：Core/SRT_Core_00_Intro.md §1.2.1.1
...
**首次出现**：Neuroscience/SRT_Consciousness_Clinical.md（历史路径，待迁移）
...
**首次出现**：Core/SRT_Experimental_Core.md
...
**首次出现**：AI/SRT_AI_Architecture.md §1.4
...
**首次出现**：Core/SRT_Core_00_Intro.md §1.2.1.2a
...
| 符号 | 首次出现文档 | 章节 |
|:-----|:-------------|:-----|
| L₀ | Core/SRT_Core_00_Intro.md | §1.2.1 |
| L₁ | Core/SRT_Core_00_Intro.md | §1.2.2 |
| L₂ | Core/SRT_Core_00_Intro.md | §1.2.3 |
| Ĝθ | Core/SRT_Core_00_Intro.md | §1.3 |
| θ | Core/SRT_Core_00_Intro.md | §1.3.2 |
| d | Core/SRT_Core_00_Intro.md | §2.3 |
| Ψ_f | Core/SRT_Core_00_Intro.md | §2.2 |
| h(t) | Core/SRT_Core_00_Intro.md | §2.2.3 |
| F | Core/SRT_Core_00_Intro.md | §2.4 |
| Ω | Core/SRT_Core_00_Intro.md | 公理A9 |
| γ | Core/SRT_Core_00_Intro.md | §1.3.2a |
| C_r | Core/SRT_Core_00_Intro.md | §3.2 |
| κ_τ | Neuroscience/SRT_Consciousness_Mechanisms.md（历史路径，待迁移） | §7.2 |
| ρ | AI/SRT_AI_Architecture.md | §1.4 |
| PCI | Neuroscience/SRT_Consciousness_Clinical.md（历史路径，待迁移） | - |
