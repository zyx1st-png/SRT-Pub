...
> Draft abstract. Ledger-checked: numbers limited to the confirmatory primary and
> the two load-bearing comparisons; designed-model scope stated; no forbidden
> claims.
