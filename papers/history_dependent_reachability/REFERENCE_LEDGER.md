...
| R-08a | §2.4, §5.2 | the score is an instance of action→outcome information; measure is NOT novel | **Empowerment** — Klyubin, Polani, Nehaniv (2005), IEEE CEC, 128–135. Read: channel capacity max_p(a) I(A^n;S′). Overlap = **MEASURE** (ours = fixed-μ instance, not maximized). Direct. **Downgrades N3 measure novelty.** | **10.1109/CEC.2005.1554676** | **VERIFIED** |
| R-08b | §2.4, §5.2 | isolating directed/attributable information from shared history | **Transfer entropy** — Schreiber (2000), Phys. Rev. Lett. 85(2):461–464. Read: conditions out common-history/shared-input info. Overlap = **MEASURE + control rationale** (yoke = behavioral analogue). Partial→direct. | **10.1103/PhysRevLett.85.461** | **VERIFIED** |
...
| R-13 | §1, §3.4 | "future reachability / reachable set" as a behavioral construct | **Successor representation** — Dayan (1993), Neural Computation 5(4):613–624. Read: discounted expected future-state occupancy = reachability/adjacency structure. Overlap = **ENDPOINT vocabulary** (background); ours is a behavioral arrival distribution under a matched-present protocol. No identification content → N4 protocol survives. | **10.1162/neco.1993.5.4.613** | **VERIFIED** |
| R-13b | §1, §2.8 | matched-present / only-slow-memory identification protocol | **searched; no tight precedent found.** Path dependence (dynamical/economic) and hidden-state/POMDP identifiability are background neighbors, not this protocol. | — | SEARCHED / NONE-FOUND |
