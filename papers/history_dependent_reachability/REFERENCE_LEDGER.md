...
| R-06 | §2.2, §2.3 | committor / escape-barrier / Kramers functionals used as W_sel readouts | **E & Vanden-Eijnden (2010)**, Annu. Rev. Phys. Chem. 61:391–420 (committor/TPT); Kramers (1940), Physica 7:284 (escape rate). Overlap = **background methodology**. | — (venue verified; DOI NEEDS-CONFIRM) | **VERIFIED (venue)** |
...
| R-09 | §2.5, §3.2 | master-yoked control design (reinforcement decoupled from own responses) | Seligman & Maier (1967), *J. Exp. Psychol.* (yoked / learned helplessness — the master-yoked design origin). Overlap = **CONTROL methodology (background)**; also underpins the controllability→consolidation motivation (R-08i). | — | NEEDS-CONFIRM (canonical) |
...
| R-12 | §2.9 | percentile bootstrap CIs; paired bootstrap | Efron (1979), *Ann. Statist.* 7(1):1–26; Efron & Tibshirani (1993). Overlap = **background methodology**. | — | NEEDS-CONFIRM (canonical) |
