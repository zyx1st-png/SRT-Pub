...
AI_DISCLOSURE = """## AI Assistance Disclosure\n\nOpenAI ChatGPT (OpenAI; accessed September 2026, including GPT-5.6 Sol during the current revision) was used as an editorial and research-assistance tool during manuscript development, including literature discovery, structural critique, language revision, and consistency checking across manuscript, code descriptions, and reported results. The tool did not serve as an author. The author reviewed the resulting material and takes full responsibility for the cited sources, experimental descriptions, analyses, claims, and submitted text. The reported numerical results come from the committed experimental runs described in the reproduction package rather than from generative-model output.\n\n"""
