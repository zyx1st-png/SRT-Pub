...
In accordance with MIT Press policy, I also disclose the use of AI assistance. OpenAI ChatGPT was used as an editorial and research-assistance tool during manuscript development, including literature discovery, structural critique, language revision, and consistency checking. It is not an author. I independently checked the cited sources, experimental code, analyses, and manuscript claims and take full responsibility for the submitted work. The reported numerical results derive from the committed experimental runs, not from generative-model output.
