...
E4_XZ_REL = "artifacts/E4_first_confirmatory_consequence_scope_results_2026-09-15.json.xz"
...
def load_payload() -> dict[str, bytes]:
    ...
    xz_bytes = payload[E4_XZ_REL]
    if sha256(xz_bytes) != EXPECTED_E4_XZ_SHA256:
        raise RuntimeError("preserved E4 XZ hash mismatch")
