...
- **Lives gradient.** The terminate-vs-reset contrast is generalized to a bounded maximum number of lives, with levels 1 (real), 2, 4, 8, and unbounded (resettable); monotonicity is summarized by a tie-aware Spearman rank correlation (with a two-sided permutation p-value) between the life budget and cooperation.
