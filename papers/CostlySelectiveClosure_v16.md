...
The controlled experiment of Section 4.5 uses a compact, pure-NumPy implementation with no external reinforcement-learning framework. Reproduction code and result files accompany the paper.
