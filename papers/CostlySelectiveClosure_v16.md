...
- **Lives gradient.** The terminate-vs-reset contrast is generalized to a bounded number of allowed respawns, with levels 1 (real), 2, 4, 8, and unbounded (resettable); monotonicity is summarized by the Spearman correlation between allowed respawns and cooperation.
