...
| 17–22 | 卷三：主体与价值后半 | 未写 | 待卷二重构和 14–16 第三类 pass 后推进 |
...
6. 后续编辑正文时必须以 `BOOK_CURRENT_STATUS.md` 中标注的稳定章节路径为准；为兼容网页工具，允许短期生成 `*_vN*.md` 独立版本文件，但需定期由本地合并到稳定文件名，并把旧稿移入版本归档或交给 Git 历史承接。
