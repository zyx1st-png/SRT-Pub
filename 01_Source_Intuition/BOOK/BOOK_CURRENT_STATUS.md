...
| 22 | 感到不等于能动 | current mainline：`Part_03_从选择到主体与价值/22_感到不等于能动.md`，`draft_v2_third_tier_candidate` | d与d_mobile独立结构区分（书稿层直觉读法限定）、§3区分低可见性状态与严格冻结态（高d+低d_mobile）、§5护栏（非治疗理论）+降承诺（不因此失去主体位）、§7CBT公平读法（大众化压缩版vs有效实践）、§8哲学压力线降调为"相邻/转写"、§9命题1删"存在形态"、卷三第一回路收束说明；draft_v2_third_tier_candidate |
