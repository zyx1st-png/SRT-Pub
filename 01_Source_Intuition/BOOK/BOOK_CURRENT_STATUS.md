...
last_pass: polish_round2_batch1_q01_q05_2026-06-12
---
...
| Q07 | `Drafts_26Q/Q07_锚定.md` | `draft_v16`（v15 去环专项；v16 润色一轮作者裁决：§4 标题“这不就是因果影响力吗？”改“‘锚定’是个多余的新词吗？”） |
| Q08 | `Drafts_26Q/Q08_不可逆性.md` | `draft_v15`（v13–v14 漏记轮次补正；v15 润色一轮：§3 三连“上一章说”去重、链条回顾引导句变形） |
| Q09 | `Drafts_26Q/Q09_现实厚度.md` | `draft_v20`（v19 润色一轮；v20 作者裁决：§4 标题“这不就是因果历史吗？”改“因果历史还不够吗？”） |
...
10. 全书语言润色第二轮：逐章行级打磨（按 `/srt-book-polish` 两刀执行：冗余压缩＋防御性语言瘦身；每章 1–4 处，整章通读后施工）。**第一批已完成（2026-06-12，Q01–Q05，17 处）**：主刀法——重复护栏收敛到正式边界节（Q01 双护栏合并、Q04 §9 边界重申段删、Q05 “再钉一遍边界”段删）、预防性道歉删除（Q01 梦例前置说明、Q02 §7 逐段道歉）、同点多现收敛（Q02 “有效≠本体论”五现、Q03 “拒绝代价”三现归 §6、Q04 “只做一件事”四现）。**刻意保留**：Q04 “最深的赌注”（理论自限）、Q05 “挑选是晚期形态”五现（核心命题链式锤打）、Q03 §4 四连负面定义（皆挡专业误读）、各章对手最强形式、沉浸式开头、首次定义。待办：第二批 Q06–Q10，后续 Q11–Q28（Q17 建议跳过——断言密度手术刚完成）。
