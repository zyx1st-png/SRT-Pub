...
| Q22 | `Drafts_26Q/Q22_方向.md` | `draft_v26`（v26 五幕重构·Stage 3：§4 第二问外包线轻收拢——显式接 §3 权力＋本体论摩擦（外包＝某个更有力量的位置把摩擦悄悄分配给回推不了的位置）；v25 新增 §3「权力：谁在分配摩擦」一节，桥接本体论摩擦→方向三问；早前从略） |
...
- Stage 5 首尾与贯通【开篇：**致读者改五幕已落**（v6）；剩 幕前/幕终·一 + 幕终·四落地 + 两座幕内幕间桥归位 + Q23–Q28 frontmatter 第四幕→第五幕改标 + 章号 renumber（选材/能动性插入致总数变化）+ Q10/Q11 独立关系复核 + 全书顺读校运动感】：幕前/幕终·一 + 致读者改五幕 + 全书顺读
