...
- **当前主任务**：第 7–10 章已收束到稳定文件名；独立版本草稿已归档到 `Versioned_Drafts/Part_02_选择的本性/`。下一步推进第 11–13 章 alignment pass。
...
| 11 | 本体论摩擦：为什么现实不会免费成形 | 待优化；现稿 `Part_02_选择的本性/11_本体论摩擦_为什么现实不会免费成形.md` 为 draft_v3 | 以第 7–10 章当前基准链为前提做 alignment pass |
...
1. **卷二施工状态**：第 7–10 章已合并为稳定文件名下的当前基准稿；第 11–13 章继续保持“待优化 / alignment pass”。
2. **卷一不再大修**：卷一 1–6 / 6b 只在后续全书一致性需要时微调。
3. **卷二主轴明确**：选择如何在已经沉积的摩擦分配中发生。
4. **第 7–10 章已收束**：它们构成卷二入口、选择算子、排除阴影和不可逆性的当前基准链。
5. **第 11 章优先**：本体论摩擦是卷二下一处机制承重节点。
...
- 卷二章节未完成新版调整前，状态保持“待优化”；第 7–10 章当前已进入 consolidated draft 状态。
- 如果第 11 章重构改变第 12–13 章任务，先更新卷二调整指导，再推进后续章节。
