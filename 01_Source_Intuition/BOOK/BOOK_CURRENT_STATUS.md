...
| Q22 | `Drafts_26Q/Q22_方向.md` | `draft_v25`（v25 五幕重构·Stage 3：新增 §3「权力：谁在分配摩擦」一节——权力＝改写他人地形/可见性/后果回流的能力，桥接本体论摩擦→方向三问；原 §3–§6 顺延 §4–§7，章末注一 §3→§4；早前从略） |
...
- Stage 3 四幕【进行中（加节为主、非新章）：本体论摩擦＝Q18 §3、权力＝Q22 §3 两节已落；下一步=幕前·四 + Q21/Q22 reframe（摩擦/外包线收拢）】：本体论摩擦节 + 权力节 + 幕前/幕终·四
