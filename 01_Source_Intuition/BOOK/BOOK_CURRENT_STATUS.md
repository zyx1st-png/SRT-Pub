...
| Q15 | `Drafts_26Q/Q15_关切维度.md` | `draft_v17`（v17 行级打磨：§7 帝国/过载例与 §5 近逐字双现改回指） |
| Q16 | `Drafts_26Q/Q16_主体沉积.md` | `draft_v22`（v22 润色一轮：链条回顾引导句变形） |
| Q17 | `Drafts_26Q/Q17_意识.md` | `draft_v26`（v25 行级压缩；v26 意识小修：§1 场景过渡、§2 “整块意识→内部副本”桥、§3 具身位沉积过渡、§4 感受质改为“后果回流进入具身位时以内承受张力显现”并加稳定选择无感守卫／失败后果、§5 中间区功能化、§6 成瘾回接 Q14、§7 替换河流比喻并压缩 Q18 预告、注 C/D/E/F 压缩） |
...
- Stage 2 三幕重心【进行中：幕前·三 `draft_v1` 已落、脚本已注册；下一步=✦新地板全景 + Q10/Q11 refold（旧 Q11 预裁剪并入 Q10）、✦主动性、幕终·三、各章世界图景深化】：✦全景 + ✦主动性 + 各章世界图景深化 + 幕前/幕终·三
