...
| 幕前·四 | `Drafts_26Q/幕前_四幕.md` | `draft_v1`（五幕重构新增·第四幕幕前：提出“秩序为什么非有不可／自由和秩序是不是天敌／凭什么服从／一种社会安排怎么判断好坏”传统大问题、指出旧问法（社会契约从现成个体让渡自由、自由=没约束把秩序当减法、给秩序找最高善奠基）都从价值/主体已成形后才开口、预告“多样价值争同一片地→摩擦只能被分配=秩序来历→自由站在秩序上→脚手架/牢笼→遮蔽→苦难→权力→方向”运动；不讲机制） |
| 幕前·五 | `Drafts_26Q/幕前_五幕.md` | `draft_v1`（五幕重构新增·第五幕幕前：提出“人被什么连成共同体／做选择承受后果是否必须有意识／历史有没有终点·秩序或理论建成后是否只需维护”传统大问题、指出旧问法（历史有终点抵达即完成、只有有意识个体才算数、一套对的理论就是不容质疑的源头）都默认“完成态”+把待交还选择的主体预设成现成清醒个体、预告“多主体存在（共同体）→AI 改写选择条件→选择是否需要意识→理论自反/失败条件→回到生成”运动；不讲机制。**真章勘察：建筑图「吸收旧幕间五」不成立（幕间桥_Q24_Q25 在幕内），故独立新增、不移动幕间桥、不改 Q23–Q28 frontmatter；幕终·四+幕间桥归位留 Stage 5**） |
...
| Q21 | `Drafts_26Q/Q21_苦难.md` | `draft_v18`（v18 五幕重构·Stage 3：§4 外包/转嫁线轻收拢——回链第十八章「摩擦消不掉只能被分配」、把转嫁点名为「分配里最坏的一种走法」、前指下一章权力；早前从略） |
...
| Q27 | `Drafts_26Q/Q27_理论自反.md` | `draft_v16`（v16 五幕重构·Stage 4：§4 末加一段**轻交还接缝**——把上一章失败条件＋本章自检三问/停止纪律显式框成本幕「**交还机制**」（对错交还给经验／使用权交还给被描述者），落地架构原意但不合并 Q26、不 renumber。早前 v11–v15 从略） |
