...
| 20 | 自指率：主体如何越积越厚 | current mainline：`Part_03_从选择到主体与价值/20_自指率_主体如何越积越厚.md`，`draft_v2_third_tier_candidate` | σ_sr 书稿层引入；五通道写回机制、健康区间澄清（高σ不是失效，排斥外部写回才是）、强反对者（RL/路径依赖/预测加工）回应、σ_sr不等于自我意识层级护栏；需按第21章自我意识凝结做入口桥接 |
| 21–22 | 卷三：主体与价值后半 | 未写 | 按卷三大纲推进：自我意识凝结、d_mobile |
