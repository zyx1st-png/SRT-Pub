...
last_pass: rc0_review_packet_created_2026-06-12
---
...
13. **RC0 外部评审阶段（2026-06-12 进入）**：施工队列 1–12 全部销账后，新增 `BOOK_RC0_REVIEW_PACKET_2026-06-12.md` 作为评审入口。**正文默认冻结**：Q00–Q28、幕间桥、致读者、附录不做正文修改，除非外部评审暴露硬伤并经作者裁决；保护区与解冻触发条件见 RC0 文件第五、六节。
