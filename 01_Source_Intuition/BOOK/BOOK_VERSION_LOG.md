...
**硬错误修复**：
- `Outline_Parts/03_卷三_从选择到主体与价值.md`：Ch14 条目文件名从不存在的 `14_承重位置_路径如何产生回流节点.md` 修正为当前主线 `14_后果攸关谁.md`，状态更新为 `draft_v3_stable_candidate`
...
**卷三回链**：
- Ch14 §3 末尾：补"承重位置 = 一的扩张达到后果不可再外包时显出的结构形态"
