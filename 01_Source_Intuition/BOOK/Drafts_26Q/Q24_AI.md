...
> **本章接住第二十三章的共同体——后果回流的通道可以被阻断；本章追问：有一类系统不必有心，就已经在大规模改写这些通道——AI。用前几章的诊断工具（牢笼、遮蔽、方向、共同体）检验AI正在做什么。**
...
这比第十九章的导航案例更难检测。导航替你判断方向，未必给你强烈奖励；AI 替你判断时，常常同时给你更快、更流畅、更像成品的正反馈。替代不是在“不舒服”中发生，而是在“我效率更高了”的感觉中发生。
...
更精确地说，当前主流 AI 处理的是信号，不等于它已经拥有自己的信息。信号只有回到一个有自身运作、能承受差异、能把后果整合进下一步选择的位置，才成为这个位置自己的信息。AI 可以高速处理信号，人和制度却往往在承受这些信号重排之后的后果。
...
能力萎缩已经不只是理论担忧。2025 年出现了第一批经过同行评审的实证显影。

在医学领域，一项发表于 *Lancet Gastroenterology & Hepatology* 的研究追踪了 AI 辅助引入前后的内镜检查表现：医生在使用 AI 辅助期间检出能力提升了，但当 AI 被撤掉、医生独立操作时，标准检查的关键指标（腺瘤检出率）从引入前的 28.4% 下降到了 22.4%——不是没有回到基线，而是低于基线。AI 帮你找到更多，但你自己找到的比以前更少了。

在教育领域，宾夕法尼亚大学沃顿商学院团队的一项随机对照实验显示了同一种结构：高中生在不受限制地使用 AI 辅助练习时，练习成绩显著高于对照组，但在无辅助考试中反而低于对照组。AI 让你练得更好——但让你考得更差。

两个独立领域，同一个结构：AI 在场时表现提升，AI 撤走后能力比原来更低。这不是工具的副作用，而是替代式结构的结构后果——第十九章的脚手架→牢笼路径在这里获得了经验显影。这批证据还年轻，效应大小有待重复验证；但两个独立领域给出同一个结构方向，而且正落在第十九章预测的位置上。

**地形型 AI：不只影响你一个人，而是改变了许多人共同选择的默认环境。** 地形型不是脚手架和牢笼之外的第三种个人关系，而是从单个具身位跳到共同地形后的结构判断。推荐算法不只是你的私人助手——它在重新安排几十亿人的信息可见性，第十一章的预裁剪在这里被工程化、规模化了。自动化招聘系统不只是一个筛选工具——它在改写整个行业的就业地形，决定谁被看见、谁被滤掉。大语言模型不只是帮你写邮件——它在重新配置知识生产的默认通道，改变什么风格、什么结构、什么内容更容易被生成。地形型 AI 的影响不是你一个人“选择怎么用”就能决定的——上一章已经说过，共同秩序不是个体选择的加总。
...
所以本节里的证据其实分成两类：医学和教育研究显示的是**牢笼型风险**——替代导致个人能力萎缩；写作实验显示的是**地形型风险**——共同地形的多样性被压缩。前者问“我撤掉 AI 后还会不会判断”，后者问“我们一起使用 AI 后，共同地形是不是变窄”。

用延展心智的语言说：脚手架型延展增强了你，牢笼型延展替代了你，地形型延展改变了你们。延展之后真正要问的不是“心智边界有没有外扩”，而是“谁还能承重，谁的能力在增长，谁的能力在萎缩”。
...
上一章的共同体三问检验共同地形的健康：后果是否能回流？承受者是否能回应？共同地形是否还能被改写？AI 不是具身位，但它对共同地形的影响和制度、平台、市场流程在结构上同类：它改变可见性、摩擦分布、默认路径和后果回流方向。因此，共同体三问可以直接迁移到 AI。
...
AI 的一个结构特征是：它把“一次决策影响几个人”放大为“一次设计决策影响几百万人”。当后果扩散到设计者根本无法感知的规模和间接程度时，回流通道在事实上被稀释了——不是有人故意切断，而是后果太分散、太间接、太滞后，制造者感知不到自己的决策对几百万人做了什么。回流稀释就是第二十章遮蔽在 AI 语境下的一种形态：后果没有消失，也未必被蓄意遮挡，只是被分散到难以回读的尺度上。
...
即便是这种自主智能体，也不需要意识才会改写地形。它可以在外部预置目标下拆分任务、选择步骤、调用工具；目标和价值仍可能来自系统外部的设定。正因为如此，治理问题不能等到“它是不是主体”才开始——只要它已经在执行会改变他人选择条件的决策序列，共同体三问就必须介入。

这里必须同时保留两条护栏，避免两个方向的滑坡。

**第一条：不把 AI 拟人化得太快。** 当前 AI 不承受后果。模型生成了错误信息，后果由使用者、被误导的人、被错误决策影响的人承担。模型不会失去工作、关系、身体、信用、地位。它处理信号，不等于它拥有具身攸关。把这种系统叫作“人”或“主体”，会掩盖真正承受后果的位置。
...
还有一条面向未来的边界：说当前 AI 不满足具身位条件，不等于说 AI 永远不可能满足。这里的判断是**架构特定的**：它针对当前主流 inference-only 部署，尤其是没有持续承重、没有自身损益、没有真实后果回写的系统。对带长期记忆、在线学习、持续目标或身体脆弱性的系统，判断会变复杂，必须重新评估哪些后果开始回到系统自身、哪些关切开始沉积、哪些摩擦开始真实产生。地形分析仍然先于意识归属——即使未来的判断需要修正。
...
一个更深的问题就此浮出水面。AI 没有意识，却能深度参与选择地形——改变菜单、改变摩擦、替代判断、重排后果回流。这把本书第二幕早已论证的命题逼到了台前：**选择不需要主体。** 现在一类非意识系统深度参与着选择地形——这不是说 AI 已经在本书意义上占据了选择位置，而是说它把选择位置的边界问题推到了台前——“选择与意识的边界在哪里”就从书房问题变成了治理问题。

但这个命题极其危险。说得太宽，它滑向“万物有心”；说得太窄，它又看不见 AI、制度、地形这些非意识结构对选择条件的真实改写。下一章要做的，就是给这条边界画线：选择与意识的边界到底在哪里？这个问题不再只是书房里的思辨，而是治理的紧迫问题。
