...
地形型影响也有了第一批实证。2024 年发表于《科学进展》（*Science Advances*）的一项写作实验显示：借助生成式 AI 提供创意的写作者，单篇作品被评为更有创意；但把所有 AI 辅助的作品放在一起看，彼此显著更相似。个体层面人人受益，集体层面多样性在收窄。这正是地形型影响的标志：它不出现在任何一个使用者的体验里，只出现在共同地形的统计结构上。
...
上一章的委托四要件——有范围、有期限、能撤销、能审查——在这里有了最锋利的应用对象。把算法放进代理结构的谱系里看，它的特殊之处立刻显形：推荐算法替你筛选整个世界，但你从未授权它做这件事（无范围）；它不设任期（无期限）；你关不掉它背后的排序逻辑（难以撤销）；你也几乎看不见它替你做了哪些决定（难以审查）。算法代理常常是**未经委托的代理**：四要件一项都不满足，却在执行人类社会有史以来规模最大的代理任务。这不是宣判每个 AI 系统都不正当——而是说，检查一个 AI 部署是否健康，可以直接沿用委托四要件：授权范围在哪里？期限和退出在哪里？撤销的通道在哪里？审查的入口在哪里？
...
到这里，一个更深的问题浮出水面。AI 没有意识，却能深度参与选择地形——改变菜单、改变摩擦、替代判断、重排后果回流。这把本书第二幕早已论证的命题逼到了台前：**选择不需要主体。** 现在一类非意识系统深度参与着选择地形，“选择与意识的边界在哪里”就从书房问题变成了治理问题。
