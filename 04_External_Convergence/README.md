# 04 External Convergence / 外部收敛证据
...
`04_External_Convergence` should answer:

- Which external findings independently converge with SRT structures?
- Which findings provide proxy measurements for `d-value`, `Psi_f`, `L2` hardening, subjecthood thresholds, or selection cost?
- Which findings strengthen a formal anchor, and which merely provide loose analogy?
...
- `Biology_Evolution/`
- `Social_Science/`
- `Mathematics_Information/`

## Current related files

The repository already contains experiment and proxy infrastructure that can feed this layer:

- [`../SRT_EXP_PRIORITY_MATRIX.md`](../SRT_EXP_PRIORITY_MATRIX.md)
- [`../SRT_EXP_MEASURE_MAP.md`](../SRT_EXP_MEASURE_MAP.md)
- [`../SRT_EXP_TEMPLATE.md`](../SRT_EXP_TEMPLATE.md)
- [`../Operations/_SRT_MATERIAL_LOG.md`](../Operations/_SRT_MATERIAL_LOG.md)
