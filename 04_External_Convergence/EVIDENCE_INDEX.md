...
| [`EC-AI-HIGH-CAPACITY-LOW-STAKE`](AI_ML/EC-AI-HIGH-CAPACITY-LOW-STAKE.md) | AI / ML | `d-value`; consequence return; capacity-stake distinction | E2 | draft_v1; not accepted | High inference / task capacity as a candidate contrast with stake-coupled consequence return and subjecthood threshold. | [`CL-AI-FUNCTIONALIST-STAKE-CHALLENGE`](CONTRADICTION_LEDGER.md#cl-ai-functionalistic-stake-challenge) |
...
| `Ψ_f` | payability, friction, transition cost, Fisher / thermodynamic / metabolic projections. |
