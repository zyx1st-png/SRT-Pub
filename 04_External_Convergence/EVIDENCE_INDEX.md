...
| [`EC-AI-HIGH-CAPACITY-LOW-STAKE`](AI_ML/EC-AI-HIGH-CAPACITY-LOW-STAKE.md) | AI / ML | `d-value`; consequence return; subjecthood threshold | E2 | draft_v1; not accepted | High inference / task capacity as a candidate contrast with stake-coupled consequence return and subjecthood threshold. | pending ledger review |
