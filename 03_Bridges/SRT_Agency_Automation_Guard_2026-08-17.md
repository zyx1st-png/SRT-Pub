---
id: SRT-AGENCY-AUTOMATION-GUARD-20260817
type: bridge_hardening
status: active
layer: L1
...
The following are **not sufficient by themselves** to establish stronger agency / subject-level revision standing:

```text
fixed script execution
habit / cached-policy replay
gradient following
L2 label optimization
routine scaffolded automation
