...
BCTB-0 T1 execution package:
ref = `experiments/grg-bctb0-t1-preexec-package-20260922`
...
-> latest fresh R3: A2-A7 PASS / A1 REVISE for one wrapper-added trailing LF
-> A1 source-boundary repair = COMPLETE / 14 of 14 historical SOURCE blocks byte-exact
-> corrected de-labelled pack regenerated by same 41-rule transform / BYTE-EXACT PASS
