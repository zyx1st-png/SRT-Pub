...
- **推荐**：把对象理解为“结晶相变”结果：
  ...
  \]
- 解释：结构不是预存于 \(L_0\) 的固定块，也不是心智任意捏造；它是模板与外部阻抗共同塑形的可维持结果。
...
5. **A7 生物／适应模型候选**：某些已声明的生物或控制模型可以优先表征生存／适应压力，再研究其与真实性的关系；这不是 primitive Selection 内建的普遍生存方向。
