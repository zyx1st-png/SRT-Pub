---
id: SRT-NAVIGATION-MAP
type: framework
tags: [Navigation, Onboarding, Registry]
status: active_v2
layer: meta
epistemic_layer: os
claim_mode: canonical
dependency: [_SRT_INDEX, _SRT_MANIFEST]
---
...
如果你要机器索引，请看 `_SRT_INDEX.md`。
如果你要运行协议，请看 `AGENTS.md`。
...
2. `Core/SRT_Core_22_Equations.md`
3. `_SRT_SYMBOL_TABLE.md`
4. `CANONICAL_REGISTRY.md`

## 我想看 AI / 意识 / 量子 / 社会方向

- AI → `AI/_SRT_AI_Bridge.md`
- Neuroscience → `Neuroscience/_SRT_Neuro_Axioms.md`
- Physics → `Physics/_SRT_Phys_Bridge.md`
...
2. `SRT_EXP_PRIORITY_MATRIX.md`
3. `SRT_EXP_TEMPLATE.md`
4. `SRT_EXP_MEASURE_MAP.md`
...
- machine index → `_SRT_INDEX.md`
- machine manifest → `_SRT_MANIFEST.yaml`
- symbol table → `_SRT_SYMBOL_TABLE.md`
