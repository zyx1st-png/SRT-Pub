...
| friction | maintenance cost, transformation pressure, boundary friction, constitutive friction, Psi_f, bearer-relative reconstruction burden | Selection Vertical §H gives maintenance/transformation roles; capacity §M splits constitutive/boundary; reach §§V/X narrow maintained-equivalence cost; 2026-09-25 second adjudication adds a broader bearer-relative gate-reconstruction burden family. This family substantially overlaps canonical Psi_f Def-Ψ-1/2 and historical Psi_f^maint but identity is not established | those owners + 2026-09-25 source / second adjudication + `_SRT_PSI_F_CANONICAL.md` + maintenance-friction row below | source-level family; crosswalk ACTIVE under CURRENT NEXT | OVERLOADED_SAME_NAME / PARTIAL_OVERLAP; do not assume either identity or total separation |
