...
| L0/L1/L2-facing | Facing, L0-facing, L1-facing, L2-facing | operational aliases / worksheet readings of the already-canonical L0/L1/L2 analytic-aspect rule; **not** new layers or substances | `_SRT_SYMBOL_TABLE.md` Aspect boundary; `Core_Law/SRT_L0_Metaphysics.md`; PR1069 corrective; Facing method v0.2 | method alias / current execution routing | ALIAS_SAME_BURDEN; prefer owner terms in definitions |
| Position-relative L0-facing | formed-position L0-facing, current Position open face | retired working phrase; graded formed closure is routed through retained constraints / generative reselectability / latent reconstructive reach, while the limit case routes to Selection anti-tautology | PR1071 final adjudication; Facing pass FRH-0 | retired working label | ALIAS_SAME_BURDEN / do not reuse as term-of-art |
| L0-facing continuity | generative continuity, renewed generativity | retired as independent term-of-art; unpack through O0 + recurrent reconstitution / One-side history + Selection-position | PR1071 final adjudication; Facing pass FRH-0 | retired working label | ALIAS_SAME_BURDEN / explanatory prose only |
| formed Orientation | Position orientation, future-facing Position | retired as independent term-of-art; route prospective non-equivalence through Selection-position + structural generative Expectation B, with C-level anticipation separately gated | PR1071 final adjudication; Expectation Typing 2026-09-20; Spine §6.3 | retired working label | ALIAS_SAME_BURDEN / explanatory prose only |
...
| methodological reconstructibility | model/cut reopenability, auditability | research-method discipline: preserve provenance, assumptions, failure boundaries, alternative cuts and recut paths; not the theory-side GRG construct | Facing method v0.2; PR1071 final adjudication | method label | OVERLOADED_SAME_NAME / always qualify |
...
| ontological friction / Ψ_f | friction, maintenance cost, transformation pressure, boundary friction, constitutive friction, bearer-relative reconstruction burden | **Controlling 2026-09-25 A-9 adjudication:** the SRT/GRG theoretical uses above refer to the same canonical Ontological Friction / `Ψ_f` concept family under different contextual emphases. Formation, maintenance, reconstruction, consciousness and agency may project different aspects; they do not create a second friction variable. Ordinary physical/mechanical friction must be qualified explicitly. | `_SRT_PSI_F_CANONICAL.md` + 2026-09-25 A6-A9 adjudication + prior GRG friction provenance | canonical concept + contextual research readings | ALIAS_TO_CANONICAL_PSI_F / CONTEXTUAL_READING; prefer `Ontological Friction (Ψ_f)` in new theory-facing prose |
| maintenance reading of ontological friction | Psi_f^maint, maintenance cost of equivalence | after A-9, maintained-equivalence burden is routed as a contextual **maintenance reading of canonical Ontological Friction / `Ψ_f`**, not as a separate friction ontology. Historical `Psi_f^maint` wording remains provenance; no new subtype symbol is admitted here. | `_SRT_PSI_F_CANONICAL.md`; SRT_Glossary.md historical wording; reach §V; 2026-09-25 A6-A9 adjudication | contextual reading / historical alias | SAME_CONCEPT / NO_NEW_SYMBOL |
...
| gate geometry | coarse-graining geometry, partition geometry, stability geometry, gating geometry | 2026-09-25 author source: working interpretation of formed gating as equivalence / boundary / neighborhood / transition-reachability / perturbation-stability structure; **not primitive Selection, not a new field substance, and not canonical `Psi_f`** | 2026-09-25 gate-geometry source + second adjudication; objectification / re-objectification; generative equivalence; supported equivalence; `Core_Law/SRT_One_Formation.md`; `_SRT_PSI_F_CANONICAL.md` Def-Ψ-1/2 | working label; priority per STATUS | WORKING_LABEL_ONLY / PARTIAL_OVERLAP; keep only if Route A/C/E subtraction leaves explanatory gain; geometry != burden |

| bridge formation | relation formation, active bridge formation, bridge genesis | active world-coupled formation / revision of a reusable relation; **not Gate by lexical identity**; may yield a formed gating organization if the result acquires the organization-level gating role | 2026-09-26 active-bridge author source + corrective convergence | source-level research | WORKING_LABEL_ONLY / PARTIAL_OVERLAP with sensorimotor learning |
| thin index | this-one index, minimal object index, tracked locus | minimal continuing locus used for individuation / tracking without rich descriptive object identity | 2026-09-26 minimal object-closure audit; PH-IND01 | research working label | PARTIAL_OVERLAP with object-file / indexing literature |
| rich object closure | reciprocal object closure, index-bridge closure | working model in which a thin index and several reusable relations mutually support re-identification, prediction, control and re-entry; not a canonical object definition | 2026-09-26 object-closure audit | research working label | WORKING_LABEL_ONLY / strong object-file neighbor pressure |
| Gate transparency | gate backgrounding, transparent gating | successful formed gating organization no longer needs to be reopened as a current problem while remaining causally operative; not phenomenal transparency by default | 2026-09-25 gate source + 2026-09-26 givenness audit | research working label | PARTIAL_OVERLAP with automaticity / background control |
| whole-field composition | whole field, field composition, mutual Gate-possibility | working relational description of compatibility / competition / nesting / transition among active and latent formed closures plus conditions on new bridge formation; **not an L0 substance or physical field** | 2026-09-26 whole-field audit + research programme | research working label | WORKING_LABEL_ONLY / strong SI-metastability-active-inference overlap |
| Form / Close / Compose | Formation / Closure / Composition typed operations | file-local formalization types for bridge formation, reciprocal closure and cross-closure composition; local audit / simulation notation only, not canonical operators and not new meanings of Gate | 2026-09-26 typed formalization + toy simulation design | local formalization only | LOCAL_ONLY / DO_NOT_CANONICALIZE by reuse |
