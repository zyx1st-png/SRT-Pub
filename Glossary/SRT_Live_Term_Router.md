...
| availability | presence, accessibility | owner **names** availability as separate in the four-way list but does not yet supply a sufficiently independent definition | capacity §D | source-level / UNDER-SPECIFIED | WORKING_LABEL_ONLY for stronger semantics |
