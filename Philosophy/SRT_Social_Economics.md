...
| d ∈ [1,2) | 短期个人规划 | 月度预算 |
| d ∈ [2,3) | 家庭/社群考量 | 储蓄、保险 |
| 极宽信息／后果窗口（理想化） | 模型域内长远考量 | 理性经济人假设；不是 actual infinite `d` |
...
完全理性模型常假定完整信息、无约束计算与固定偏好，因此可在其已声明的模型域内求技术性全局最优；现实中的算子受有限信息、预算、历史与既有 $\theta$ 约束，通常只能比较其可达域内的候选。这里不能用“$d$ 无限”替代完整信息或计算能力。
