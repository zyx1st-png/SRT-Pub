...
- claim-mode 分布：T-COLL-1/3/4 为 P1-candidate；T-PROJ-1^{coll}（§4.7）为 P1-candidate（集体投影定理）；Def-C-2 `M(t)` 结构、三类退化与 §4 耦合为 P2；政治/制度/历史判断为 P3/P4，下推至 Philosophy/
