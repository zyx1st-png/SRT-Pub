...
> **状态更新（2026-06-05）：** 当前材料主流程以 `Operations/_SRT_MATERIAL_PIPELINE.md` 为准；本文件仅保留为 legacy patch-proposal reference。
...
5. 边界声明为正式 header。
6. 在 workspace 根目录通过 `./scripts/run_srt_checks.sh`（若本轮涉及 SRT 文件规范调整）。
