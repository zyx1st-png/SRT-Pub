...
This Annex contains comparison/interface material extracted from `Neuroscience/SRT_Neuro_09_Integ_Eq.md` §1, §2.2, §3, and §4. The owner file retains the formal anchors.
