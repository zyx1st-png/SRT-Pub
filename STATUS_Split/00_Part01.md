...
**研究种子**
- 研究种子（research seed） → `90_Backstage/Incubation/_SRT_DIRECTION3_L0_PROBE_RESEARCH_SEED.md`
- 原型种子（prototype seed） → `90_Backstage/Incubation/_SRT_DIRECTION3_CHOICEMAP_PROTOTYPE_SEED.md`
- 校准参照集（calibration reference set） → `90_Backstage/Incubation/_SRT_DIRECTION3_CHOICEMAP_CALIBRATION_SET.md`

**产品感测试留痕**
- 产品感备忘录（product-feel pilot memo） → `90_Backstage/Incubation/_SRT_DIRECTION3_CHOICEMAP_PRODUCTFEEL_MEMO.md`
