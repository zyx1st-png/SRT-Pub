...
FULL_BOOK_PARTS = [
    ...
    ("Q22_方向.md",        None),
    # 幕终·四
    ("幕间桥_四五幕.md",   "幕间　自由和秩序，到底是不是天敌？"),
    # 第五幕
    ("幕前_五幕.md",       "第五幕　从秩序回到生成"),
    ("Q23_共同体.md",      None),
    # 幕间（第五幕内部）
...
> 本试读版面向有哲学背景的读者。收录完整第一幕（序章 + Q01–Q04 + 幕终·一），加上选材章与选择章、价值论、意识、方向、可证伪性、理论自反与终章。源稿仍保留 Q00–Q28 线索，并以 Q04b / Q15b 作为主题章；本版不预设最终出版章号。
>
...
PHIL_PARTS = [
    ...
    ("Q04_最低非中立性.md", None),
    ("幕间桥_一二幕.md",   "幕间　换上新镜片：没有现成的起点"),
    ("Q04b_选材.md",       "第二幕（节选）　在选择之前"),
    ("Q05_选择不是挑选.md", None),
    ("Q14_价值不是偏好.md", "第三幕（节选）　价值不是偏好"),
    ("Q17_意识.md",        "第三幕（节选）　意识"),
    ("Q22_方向.md",        "第四幕（节选）　方向"),
    ("Q26_可证伪性.md",    "第五幕（节选）　可证伪性"),
    ("Q27_理论自反.md",    None),
    ("Q28_回到生成.md",    "终章　回到生成"),
]
